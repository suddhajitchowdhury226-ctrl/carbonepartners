...
const SmsfFormationPage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="SMSF Formation" subtitle="Setting Up Your Fund" />
      <ContentSection content={
        <>
          <p style={{ marginBottom: 40, fontSize: 17, color: '#080f1e', fontWeight: 500 }}>
          ...
          <h2 style={{ fontSize: 22, fontWeight: 800, color: '#143c82', marginBottom: 24 }}>We can help you in every aspect of setting up your SMSF:</h2>
...
export default SmsfFormationPage;
