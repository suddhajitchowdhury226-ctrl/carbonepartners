...
const SmsfIntroPage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="SMSF Intro" subtitle="Introduction to SMSF" />
      <ContentSection content={
        <>
          <p style={{ marginBottom: 24, fontSize: 17, color: '#080f1e', fontWeight: 500 }}>
            Self-Managed Superannuation Funds (SMSF) embodies one of the biggest areas of investment for retirement in Australia. Carbone Partners has a dedicated, experienced and innovative team of specialists to guide you through the complexity of self-managed superannuation.
          </p>
          <h2 style={{ fontSize: 24, fontWeight: 800, color: '#143c82', marginBottom: 16, marginTop: 48 }}>What is an SMSF?</h2>
          <div style={{ width: 40, height: 3, background: '#c8a96e', marginBottom: 20, borderRadius: 2 }} />
          <p style={{ marginBottom: 20 }}>
            An SMSF is a trust structure that provides members with an income for retirement. The self-managed aspect of this type of fund is its main distinctive feature, and means that members can make the investment decisions that will decide their future income. 
          </p>
          <p style={{ marginBottom: 20 }}>
            If you wish to take responsibility for your own finances and don’t want to entrust all your investments to an external party, then an SMSF could be right for you.
          </p>
        </>
      } />
      <CTABanner />
