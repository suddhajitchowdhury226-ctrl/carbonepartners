...
const LiabilityInsurancePage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="Liability Insurance" subtitle="Minimising Business Impact" />
      <ContentSection content={
        <>
          <p style={{ marginBottom: 32, fontSize: 17, color: '#080f1e', fontWeight: 500 }}>
            You may be responsible for damages or injuries to another person or property caused by your business activities. You can get liability insurance to minimise the impact to your business. 
          </p>
          
          <h2 style={{ fontSize: 20, fontWeight: 800, color: '#143c82', marginBottom: 20 }}>Some typical cover includes:</h2>
