...
import {
  ...
  CheckCircle2, TrendingUp, Users, Target, Shield,
  BarChart2, Briefcase, Award, Zap, Building2, BookOpen
} from 'lucide-react';
...
const PageHero = ({ onBack }) => (
  <section style={{
    ...
    <div style={{ position: 'absolute', right: 140, top: '50%', transform: 'translateY(-50%)', opacity: 0.05, pointerEvents: 'none', zIndex: 2 }}>
      <Briefcase size={260} color="#fff" strokeWidth={0.8} />
    </div>
    ...
    <div className="container" style={{ position: 'relative', zIndex: 3, padding: '60px 32px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 32 }}>
        ...
        <ChevronRight size={11} color="rgba(255,255,255,0.3)" />
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, textTransform: 'uppercase', color: '#c8a96e' }}>Consulting</span>
      </div>
      ...
      <h1 style={{ fontSize: 'clamp(32px,5vw,64px)', fontWeight: 900, lineHeight: 1.05, letterSpacing: -1.5, color: '#fff', marginBottom: 22, maxWidth: 720 }}>
        Strategic<br />
        <span style={{ color: '#c8a96e' }}>Business</span> Consulting
      </h1>
      ...
      <p style={{ fontSize: 15.5, lineHeight: 1.85, color: 'rgba(255,255,255,0.62)', maxWidth: 600, marginBottom: 44 }}>
        We have the formal qualifications and technical ability to deliver practical advice that makes a real difference. We partner with you as an independent advisor to challenge your thinking and achieve your financial goals.
      </p>
      ...
      <div style={{ marginTop: 52, paddingTop: 28, borderTop: '1px solid rgba(255,255,255,0.10)', display: 'flex', gap: 40, flexWrap: 'wrap' }}>
        {[
          { label: 'Virtual CFO', sub: 'Executive financial oversight' },
          { label: 'Unbiased Advice', sub: 'Independent external perspective' },
          { label: 'Growth Focused', sub: 'Scaling and exit strategies' },
        ].map(({ label, sub }) => (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 72, alignItems: 'center' }} className="bc-intro-grid">
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(24px,3.2vw,42px)', fontWeight: 900, lineHeight: 1.1, letterSpacing: -1, color: '#080f1e', marginBottom: 20 }}>
              ...
              <span style={{ color: '#143c82' }}>Accessible to SMEs.</span>
            </h2>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.9, color: '#464650', marginBottom: 20 }}>
              Large corporations employ a full-time Chief Financial Officer (CFO) to oversee cash flow, mitigate risk, and identify growth opportunities. This crucial role often determines success or failure, yet the price tag puts it out of reach for most small to medium businesses.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.9, color: '#464650', marginBottom: 20 }}>
              <strong style={{ color: '#080f1e' }}>Hiring a Virtual CFO breaks this cycle.</strong> It brings an impartial, high-level advisor into your business to track progress, optimize processes, and guide you toward your goals.
            </p>
            <p style={{ fontSize: 15, lineHeight: 1.9, color: '#464650', marginBottom: 36 }}>
              Because our advisors are external, their advice remains unbiased. We often identify unseen risks and unexploited opportunities that internal teams miss.
            </p>
          </div>

          <div style={{ background: 'linear-gradient(135deg,#080f1e 0%,#0c1a36 100%)', padding: '52px 44px', borderTop: '4px solid #c8a96e' }}>
            <h3 style={{ fontSize: 20, fontWeight: 800, color: '#fff', marginBottom: 24 }}>A Virtual CFO Helps You With:</h3>
            <ul style={{ display: 'flex', flexDirection: 'column', gap: 16, margin: 0, padding: 0, listStyle: 'none' }}>
              {[
                'Goal setting & progress tracking',
                'Making business processes efficient',
                'Cash flow & time management',
                'New venture risk analysis',
                'Measuring real business growth',
                'Exiting with maximum sale value'
              ].map((item, i) => (
...
════════════════════════════════════ */
const capabilities = [
  { Icon: Target, color: '#143c82', title: 'Business Mentoring', desc: 'Coaching and mentoring to hold you accountable, set clear objectives, and develop strong business plans.' },
  { Icon: TrendingUp, color: '#0f2f68', title: 'Cash Flow & Buds', desc: 'Detailed budgeting and cash flow projections ensuring you have the capital you need to scale safely.' },
  { Icon: Shield, color: '#1a4fa0', title: 'Risk Management', desc: 'Asset protection, crisis planning, and risk analysis to safeguard your wealth against unforeseen events.' },
  { Icon: Building2, color: '#143c82', title: 'Business Structures', desc: 'Advice on the right entities — companies, trusts, partnerships, or sole traders — for tax efficiency and protection.' },
  { Icon: Briefcase, color: '#0f2f68', title: 'Acquisitions & Sales', desc: 'Buying, selling, merging, or restructuring businesses. We guide you through valuation and due diligence.' },
  { Icon: BarChart2, color: '#1a4fa0', title: 'Strategy & KPIs', desc: 'Benchmarking performance against industry standards and building robust KPIs to measure what matters.' },
];
        ...
        <Reveal>
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: 'clamp(24px,3.2vw,40px)', fontWeight: 900, lineHeight: 1.08, letterSpacing: -1, color: '#080f1e', marginBottom: 16 }}>
              Tailored Business <span style={{ color: '#143c82' }}>Solutions</span>
            </h2>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 48, flexWrap: 'wrap' }}>
          <div style={{ maxWidth: 580 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 18 }}>
              <div style={{ width: 36, height: 2, background: '#c8a96e' }} />
              <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: 'rgba(255,255,255,0.50)' }}>Scale Your Business</span>
            </div>
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.85, color: 'rgba(255,255,255,0.55)', maxWidth: 480 }}>
              Whether you need a full Virtual CFO or just help preparing for an acquisition, we will actively partner with you to achieve a greater outcome.
            </p>
          </div>
...
/* ════════════════════════════════════
   ROOT EXPORT
════════════════════════════════════ */
const BusinessConsultingPage = ({ onBack }) => {
