...
const AssetsRevenuePage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="Assets & Revenue Insurance" subtitle="Protecting Business Assets" />
...
export default AssetsRevenuePage;
