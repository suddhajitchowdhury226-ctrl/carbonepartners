  ...
  <section style={{
    ...
    <div className="container" style={{ position: 'relative', zIndex: 3, padding: '60px 32px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 32 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 1.5, textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)' }}>Insurance</span>
        <ChevronRight size={11} color="rgba(255,255,255,0.3)" />
...
const CTABanner = () => (
  <section id="insurance-contact" style={{ background: 'linear-gradient(135deg,#0c1a36 0%,#080f1e 100%)', padding: '80px 0', position: 'relative', overflow: 'hidden', borderTop: '4px solid #c8a96e' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 48, flexWrap: 'wrap' }}>
          <div style={{ maxWidth: 580 }}>
            ...
            <p style={{ fontSize: 14.5, lineHeight: 1.85, color: 'rgba(255,255,255,0.55)', maxWidth: 480 }}>
              Let’s discuss how we can comprehensively protect your business, assets, and future.
            </p>
          </div>
...
const PersonalWorkersPage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="Personal & Workers Insurance" subtitle="Covering the Unexpected" />
      <ContentSection content={
        <>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 36 }}>
            {[
              { title: 'Workers’ compensation insurance', desc: 'This is mandatory when employing staff.' },
              { title: 'Personal accident, illness and life insurance', desc: 'Financial protection for you and your loved ones.' },
              { title: 'Income protection insurance', desc: 'Replacement income if you are temporarily unable to work.' }
            ].map((item, i) => (
          ...
          <div style={{ background: '#f8f9fa', padding: '36px', borderRadius: 12, borderLeft: '4px solid #c8a96e' }}>
            <p style={{ margin: 0, lineHeight: 1.8, color: '#464650' }}>
              <strong>If you are a sole trader or partner</strong> you are not covered by workers’ compensation insurance. In the event of an illness or accident you may not be able to work and earn an income. Insurance is strongly recommended to cover you in this circumstance.
            </p>
          </div>
        </>
      } />
...
export default PersonalWorkersPage;
