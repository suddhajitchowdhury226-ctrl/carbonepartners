...
const BookkeepingSrvPage = ({ onBack }) => {
  useEffect(() => { window.scrollTo({ top: 0, behavior: 'smooth' }); }, []);
  return (
    <div>
      <PageHero onBack={onBack} title="Bookkeeping" subtitle="Reliable Tailored Services" />
      <ContentSection content={
        <>
          <p style={{ marginBottom: 24, fontSize: 17, color: '#080f1e', fontWeight: 500, lineHeight: 1.8 }}>
            Whether you run a busy small business or a bigger and more complicated one, our team can provide you with a professional and reliable bookkeeping service that is individually tailored to your business needs.
          </p>
          <p style={{ marginBottom: 36, lineHeight: 1.8 }}>
            Leave the paperwork to us. Our experienced bookkeepers can work on-site or remotely to help you sort out your accounts and save you time and stress, so you can do what you do best.
          </p>
          
          <h2 style={{ fontSize: 20, fontWeight: 800, color: '#143c82', marginBottom: 20 }}>Our Bookkeeping services include:</h2>
...
export default BookkeepingSrvPage;
